...
func _ready() -> void:
	...
	activate_sound_.stream = preload("res://Assets/Audio/sounds/activate.wav")
	add_child(activate_sound_)
	
	select_sound_ = AudioStreamPlayer.new()
	select_sound_.stream = preload("res://Assets/Audio/sounds/select.wav")
	add_child(select_sound_)
	
	cancel_sound_ = AudioStreamPlayer.new()
	cancel_sound_.stream = preload("res://Assets/Audio/sounds/cancel.wav")
